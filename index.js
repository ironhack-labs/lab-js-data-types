...
const lastToUp1 = lastChar1.toUpperCase();
const part1LastToUp = part1.slice(0,3) + lastToUp1;

const lastChar2 = part2.slice(-1);
const lastToUp2 = lastChar2.toUpperCase();
const part2LastToUp = part2.slice(0,5) + lastToUp2;

const result = part1LastToUp + part2LastToUp;
...
const totalAmount = billTotal * 15 / 100 + billTotal;
