...
// (max - min + 1) + min --> this +1 it's to include the max number in this case 10 and I use Math.floor to don't get 11 in case the random numbers it's 10.6 for example. 
