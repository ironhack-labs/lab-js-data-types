...
const camelTailPt1 = part1.slice(0,-1) + part1.charAt(part1.length - 1).toUpperCase()
const camelTailPt2 = part2.slice(0,-1) + part2.charAt(part2.length - 1).toUpperCase()

const camelTail = camelTailPt1 + camelTailPt2;
