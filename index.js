...
const part1Modified = part1.slice(0, part1.length - 1)    // jav
                    + part1[part1.length - 1].toUpperCase()  // A

const part2Modified = part2.slice(0, part2.length - 1) // scrip
                    + part2[part2.length - 1].toUpperCase() // T
console.log(part1Modified)
console.log(part2Modified)


// Print the cameLtaiL-formatted string
console.log (part1Modified + part2Modified)
