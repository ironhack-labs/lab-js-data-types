...
let restPart1 = part1.slice(0, -1)
const camelTailPart1 = restPart1 + lastLetterPart1

let lastLetterPart2 = part2.slice(-1).toUpperCase()
let restPart2 = part2.slice(0, -1)
const camelTailPart2 = restPart2 + lastLetterPart2
